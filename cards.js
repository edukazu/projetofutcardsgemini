...
const TEAMS_DATA = {
    ...
    catalonia: {
        ...
        players: [
            ...
            { id: "fcb_rm", name: "Dani O.", role: "MID", ovr: 84, nation: "es", face: 2, skin: "#f5d0b0", pas: 83, dri: 82, sta: 85, zone: 2 },
            { id: "fcb_st1", name: "R. Lewan", role: "ATT", ovr: 88, nation: "pl", face: 1, skin: "#f5d0b0", dri: 80, fin: 92, sta: 75, zone: 3 },
            { id: "fcb_st2", name: "Raph", role: "ATT", ovr: 84, nation: "br", face: 4, skin: "#c68642", dri: 85, fin: 80, sta: 88, zone: 3 }
        ]
    }
};